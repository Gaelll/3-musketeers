...
test('should add a new currency', () => {
  convert.addUnit('JPY', 0.00938);
  expect(convert.units()).toContain('JPY');
});

test('should remove a currency', () => {
  convert.removeUnit('JPY');
  expect(convert.units()).not.toContain('JPY');
});

test('should throw when currency is already existing', () => {
